...
const SUPABASE_KEY = process.env.VITE_SUPABASE_ANON_KEY || 'dummy-key';

const supabase = createClient(SUPABASE_URL, SUPABASE_KEY);

const RESIDENT_EMAIL = 'contacto@rockcode.cl';
const RESIDENT_PASSWORD = process.env.TEST_RESIDENT_PASSWORD || 'dummy_resident_pwd'; // Assuming this is the password from previous context
...
test.describe('Reservations - Morosity Check', () => {
    ...
    test.beforeAll(async () => {
        ...
        const { error: adminError } = await supabase.auth.signInWithPassword({
            ...
            password: process.env.TEST_ADMIN_PASSWORD || 'dummy_admin_pwd'
        });

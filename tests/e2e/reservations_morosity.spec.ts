...
const RESIDENT_PASSWORD = process.env.TEST_RESIDENT_PASSWORD || 'resident_pass'; // Assuming this is the password from previous context
...
test.describe('Reservations - Morosity Check', () => {
    ...
    test.beforeAll(async () => {
        ...
        const { error: adminError } = await supabase.auth.signInWithPassword({
            ...
            password: process.env.TEST_ADMIN_PASSWORD || 'admin_pass'
        });

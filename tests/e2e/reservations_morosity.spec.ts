...
const RESIDENT_PASSWORD = process.env.TEST_RESIDENT_PASSWORD || 'dummy_password'; // Assuming this is the password from previous context
...
test.describe('Reservations - Morosity Check', () => {
    ...
    test.beforeAll(async () => {
        ...
        const { error: adminError } = await supabase.auth.signInWithPassword({
            email: process.env.TEST_ADMIN_EMAIL || 'dummy_admin@example.com',

...
const RESIDENT_PASSWORD = process.env.TEST_RESIDENT_PASSWORD || '180381';       // REPLACE WITH REAL RESIDENT PASSWORD
const ADMIN_EMAIL = 'rockwell.harrison@gmail.com';       // REPLACE WITH REAL ADMIN EMAIL
const ADMIN_PASSWORD = process.env.TEST_ADMIN_PASSWORD || '270386';          // REPLACE WITH REAL ADMIN PASSWORD
// ==========================================

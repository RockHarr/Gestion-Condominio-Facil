...
- paragraph: Ingresa tu correo para continuar
- text: Correo Electrónico
- textbox "Correo Electrónico":
  - /placeholder: tu@email.com
- button "Enviar enlace de acceso"
- button "Usar contraseña"
```
...
```ts
  ...
  23 |         await page.fill('input[type="password"]', process.env.TEST_ADMIN_PASSWORD || 'dummy_admin_pwd'); // Assuming test creds

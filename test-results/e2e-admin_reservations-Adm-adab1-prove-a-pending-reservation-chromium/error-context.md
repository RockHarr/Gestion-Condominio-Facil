...
- text: Contraseña
- textbox "Contraseña": dummy_resident_pwd
...
```ts
  ...
  7   | const RESIDENT_PASSWORD = process.env.TEST_RESIDENT_PASSWORD || 'dummy_resident_pwd';
  8   | const ADMIN_EMAIL = 'rockwell.harrison@gmail.com';
  9   | const ADMIN_PASSWORD = process.env.TEST_ADMIN_PASSWORD || 'dummy_admin_pwd';
  10  | // ==========================================
  11  |

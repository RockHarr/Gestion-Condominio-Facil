...
export const ExpenseStatementModal: React.FC<ExpenseStatementModalProps> = ({
  ...
  const monthName = new Date(parseInt(yearStr), parseInt(monthStr) - 1).toLocaleString('es-CL', {
    month: 'long',
  });
  ...
  const expensesByCategory = communityExpenses.reduce(
    (acc, expense) => {
        ...
        <div className="p-8 md:p-12 print:p-10 bg-white rounded-b-xl text-gray-900">
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-10">
            ...
            <div className="flex-1 text-sm text-gray-600">
              <h3 className="font-bold text-gray-900 mb-3 border-b border-gray-200 pb-1">
                Detalle del Cálculo
              </h3>
            ...
            <div className="flex-1 bg-blue-50 border border-blue-100 rounded-xl p-6 print:bg-gray-50 print:border-gray-300">
              <h3 className="font-bold text-blue-900 mb-4 text-center uppercase tracking-wider print:text-black">
                Resumen a Pagar
              </h3>
              <div className="space-y-3">
                ...
                <div className="border-t-2 border-blue-200 pt-3 mt-2 flex justify-between items-baseline print:border-gray-400">
                  ...
                  <span className="text-3xl font-bold text-blue-600 print:text-black">
          ...
          <div className="mt-12 pt-6 border-t border-gray-200 text-center text-xs text-gray-500 break-inside-avoid">
            <p className="mb-1">
              ¿Dudas con tu cobro? Escríbenos a contacto@condominiofacil.cl o llama al +56 2 2345
              6789.
            </p>
            <p>
              Este documento es un estado de cuenta informativo generado el{' '}

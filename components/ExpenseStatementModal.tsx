            ...
            >
                ...
                <div className="flex-none bg-gray-50 border-b border-gray-200 p-4 flex justify-between items-center rounded-t-xl print:hidden">
                    ...
                    <div className="flex gap-3">
                        <button onClick={onClose} className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-800 hover:bg-gray-100 focus-visible:ring-2 focus-visible:ring-blue-500 rounded-lg transition-colors" aria-label="Cerrar modal">
                            Cerrar
                        </button>

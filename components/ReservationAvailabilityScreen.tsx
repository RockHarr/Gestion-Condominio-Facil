...
export const ReservationAvailabilityScreen: React.FC<ReservationAvailabilityScreenProps> = ({
  amenity,
  onBack,
  onSuccess,
}) => {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                Revisa la disponibilidad para {amenity.name}. Toca un día para ver horarios o
                reservar.
              </p>
            </div>
          </div>

                ...
                {navItems.map(item => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center w-full h-full space-y-1 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-500 ${isActive
...
export const AdminSidebar: React.FC<AdminSidebarProps> = ({ currentPage, onNavigate, onLogout, pendingTicketsCount = 0, pendingReservationsCount = 0 }) => {
    ...
    return (
        <aside className="hidden md:flex md:flex-col md:w-72 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 shadow-xl z-30">
            ...
            <nav aria-label="Navegación lateral" className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                {navItems.map(item => {
                    ...
                    return (
                        <button
                            ...
                            onClick={() => onNavigate(item.page as Page)}
                            aria-current={isActive ? 'page' : undefined}
                            className={`w-full flex items-center px-4 py-3.5 text-sm font-medium rounded-xl transition-all duration-200 group focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 ${isActive

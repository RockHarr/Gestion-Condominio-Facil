...
export const AdminPaymentEntry: React.FC<AdminPaymentEntryProps> = ({ users, onRegisterPayment }) => {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto animate-page pb-24">
            <div className="mb-8">
                ...
                <p className="text-gray-500 dark:text-gray-400">Ingreso manual de pagos recibidos por conserjería o administración.</p>
            </div>
                    ...
                    <Card>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Monto (CLP)</label>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Periodo (Mes)</label>
                                <input
                                    type="month"
                                    value={periodo}
                                    ...
                                    required
                                />
                                <p className="text-xs text-gray-500 mt-1">Mes al que corresponde el pago (generalmente el actual o anterior).</p>
                            </div>
                    ...
                    {lastPayment && (
                        <div className="bg-green-50 dark:bg-green-900/20 rounded-2xl p-6 border border-green-100 dark:border-green-800 animate-in fade-in slide-in-from-top-4">
                            ...
                            <p className="text-sm text-green-800 dark:text-green-200 mb-4">
                                El pago de {new Intl.NumberFormat('es-CL', { style: 'currency', currency: 'CLP' }).format(lastPayment.monto)} ha sido registrado exitosamente.
                            </p>
                            <Button

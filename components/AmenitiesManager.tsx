          ...
          {amenities.map((amenity) => (
            ...
            >
              <div className="aspect-video w-full bg-gray-100 dark:bg-gray-800 rounded-lg mb-4 overflow-hidden relative">
                ...
                <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 group-focus-within:opacity-100 transition-opacity">
                  <button

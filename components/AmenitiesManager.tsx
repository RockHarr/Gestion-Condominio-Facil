              ...
              <div className="aspect-video w-full bg-gray-100 dark:bg-gray-800 rounded-lg mb-4 overflow-hidden relative">
                ...
                <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                  ...
                  <button
                    ...
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-blue-50 text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500" aria-label="Editar espacio"
                  >
                    <Icons name="pencil" className="w-4 h-4" />
                  </button>
                  <button
                    onClick={() => handleDelete(amenity.id)}
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-red-50 text-red-600 focus:outline-none focus:ring-2 focus:ring-red-500" aria-label="Eliminar espacio"
                  >

        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <button
              ...
              className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-full p-1 -ml-1"
              aria-label="Volver"
            >

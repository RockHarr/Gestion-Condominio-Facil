              ...
              <div className="aspect-video w-full bg-gray-100 dark:bg-gray-800 rounded-lg mb-4 overflow-hidden relative">
                ...
                <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-green-50 focus-visible:ring-2 focus-visible:ring-green-500 text-green-600"
                  ...
                  <button
                    type="button"
                    aria-label={`Editar amenity ${amenity.name}`}
                    onClick={() => handleOpenModal(amenity)}
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-blue-50 focus-visible:ring-2 focus-visible:ring-blue-500 text-blue-600"
                  >
                    <Icons name="pencil" className="w-4 h-4" />
                  </button>
                  <button
                    type="button"
                    aria-label={`Eliminar amenity ${amenity.name}`}
                    onClick={() => handleDelete(amenity.id)}
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-red-50 focus-visible:ring-2 focus-visible:ring-red-500 text-red-600"
                  >

              ...
              <div className="aspect-video w-full bg-gray-100 dark:bg-gray-800 rounded-lg mb-4 overflow-hidden relative">
                ...
                <div className="absolute top-2 right-2 flex gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                  <button
                    ...
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-green-50 focus-visible:ring-2 text-green-600"
                  ...
                  <button
                    ...
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-blue-50 focus-visible:ring-2 text-blue-600"
                  ...
                  <button
                    ...
                    className="p-2 bg-white/90 dark:bg-gray-800/90 rounded-full shadow-sm hover:bg-red-50 focus-visible:ring-2 text-red-600"
          ...
          <Card className="w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-700 pb-4 mb-4">
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-500 focus-visible:ring-2 rounded-full p-1"

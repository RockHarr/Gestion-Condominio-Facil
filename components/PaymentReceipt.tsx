...
export const PaymentReceipt: React.FC<PaymentReceiptProps> = ({ payment, user, onClose }) => {
  const handlePrint = () => {
    window.print();
  };
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 print:p-0 print:block print:static">
      ...
      {/* Modal Container */}
      <div className="relative bg-white w-full max-w-2xl rounded-xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden print:shadow-none print:w-full print:max-w-none print:rounded-none print:max-h-none print:h-auto print:block animate-in fade-in zoom-in-95 duration-200">
        {/* Toolbar - Sticky at top */}
        <div className="flex-none bg-gray-50 border-b border-gray-200 p-4 flex justify-between items-center print:hidden">
        ...
        {/* Scrollable Content */}
        <div
          className="flex-1 overflow-y-auto p-8 md:p-12 print:p-0 print:overflow-visible bg-white"
          id="receipt-content"
        >
          {/* Header */}
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            ...
            <div className="text-right">
              ...
              <p className="text-gray-900">
                <span className="font-medium">Periodo:</span> {payment.periodo}
              </p>
            </div>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr>
                  <td className="py-4 px-4 text-gray-900">
                    ...
                    {payment.observacion && (
                      <p className="text-sm text-gray-500 mt-1">{payment.observacion}</p>
                    )}
                  </td>
              ...
              <tfoot>
                <tr className="border-t-2 border-gray-900">
                  <td className="py-4 px-4 text-right font-bold text-gray-900 uppercase">
                    Total Pagado
                  </td>
          ...
          <div className="mt-12 text-center">
            <p className="text-xs text-gray-400">
              Este documento es un comprobante válido de pago para la administración del condominio.
            </p>
          </div>
        </div>
      </div>

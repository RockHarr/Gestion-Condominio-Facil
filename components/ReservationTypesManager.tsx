        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <button
              ...
              className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus-visible:ring-2 focus-visible:outline-none rounded-full p-1 -ml-1"
            ...
            >
              <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-1.5 bg-gray-100 dark:bg-gray-700 rounded-lg text-blue-600 hover:bg-blue-50 focus-visible:ring-2 focus-visible:outline-none"
                ...
                <button
                  ...
                  className="p-1.5 bg-gray-100 dark:bg-gray-700 rounded-lg text-red-600 hover:bg-red-50 focus-visible:ring-2 focus-visible:outline-none"
          ...
          <Card className="w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-700 pb-4 mb-4">
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-500 focus-visible:ring-2 focus-visible:outline-none rounded-full p-1"

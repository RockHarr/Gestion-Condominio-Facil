...
export const ReservationTypesManager: React.FC<ReservationTypesManagerProps> = ({
  onNavigate,
  amenityId,
}) => {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingType) {
        ...
        const { error } = await supabase.from('reservation_types').insert([typeData]);
        if (error) throw error;
      }
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <button
              ...
              className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 focus-visible:ring-2 focus-visible:outline-none rounded-sm"
            ...
            >
              <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity">
                <button
                  ...
                  className="p-1.5 bg-gray-100 dark:bg-gray-700 rounded-lg text-blue-600 hover:bg-blue-50 focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:outline-none"
                ...
                <button
                  ...
                  className="p-1.5 bg-gray-100 dark:bg-gray-700 rounded-lg text-red-600 hover:bg-red-50 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
              ...
              <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {type.fee_amount > 0 ? `$${type.fee_amount.toLocaleString()}` : 'Gratis'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Garantía:</span>
                  <span className="font-medium">
                    {type.deposit_amount > 0
                      ? `$${type.deposit_amount.toLocaleString()}`
                      : 'No requiere'}
                  </span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={`font-medium ${type.requires_approval ? 'text-yellow-600' : 'text-green-600'}`}
                  >
          ...
          <Card className="w-full max-w-lg shadow-2xl animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-700 pb-4 mb-4">
              ...
              <button
                ...
                className="text-gray-400 hover:text-gray-500 focus-visible:ring-2 focus-visible:outline-none rounded-sm"
                aria-label="Cerrar modal de tipo de reserva"
              >

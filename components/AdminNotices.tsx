...
export const AdminNoticesScreen: React.FC<AdminNoticesScreenProps> = ({ notices, onNavigate }) => {
  ...
  const getTypeIcon = (type: NoticeType) => {
    switch (type) {
      case NoticeType.EMERGENCIA:
        return 'exclamation-triangle';
      case NoticeType.MANTENIMIENTO:
        return 'wrench-screwdriver';
      case NoticeType.COMUNIDAD:
        return 'users';
      default:
  ...
  return (
    <div className="animate-page pb-24">
      <Header title="Mural de Avisos" onBack={() => onNavigate('admin-dashboard')} />
      <div className="p-6 max-w-5xl mx-auto space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Gestión de Avisos</h2>
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Gestiona las comunicaciones a la comunidad
            </p>
          </div>
          <Button
            ...
            <div key={notice.id} className="group relative">
              ...
              >
                <div className="flex justify-between items-start mb-3">
                    ...
                    className={`p-2 rounded-lg ${
                      notice.tipo === NoticeType.EMERGENCIA
                        ...
                        : notice.tipo === NoticeType.MANTENIMIENTO
                          ...
                          : notice.tipo === NoticeType.COMUNIDAD
                  ...
                  <span
                    className={`text-xs font-bold px-2.5 py-1 rounded-full border ${getStatusColors(notice.status)}`}
                  >
                    {notice.status}
                  </span>
                </div>
...
export const AdminNoticeDetailScreen: React.FC<AdminNoticeDetailScreenProps> = ({
  notice,
  onApprove,
  onBack,
}) => {
        ...
        {notice.status === NoticeStatus.BORRADOR && (
          <div className="fixed bottom-24 left-0 right-0 px-4 md:static md:p-0 flex justify-center">
            <Button
              ...
              className="w-full md:w-auto shadow-xl shadow-green-500/30 bg-green-600 hover:bg-green-700 focus:ring-green-500 text-lg py-3 px-8"
            >
...
export const AdminCreateNoticeScreen: React.FC<AdminCreateNoticeScreenProps> = ({
  onAddNotice,
  onBack,
}) => {
  ...
  return (
    <div className="animate-page pb-24">
      <Header title="Redactar Nuevo Aviso" onBack={onBack} />
      <div className="p-4 md:p-8 max-w-3xl mx-auto space-y-6">

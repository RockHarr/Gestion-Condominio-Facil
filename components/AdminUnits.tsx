...
export const AdminUnitsScreen: React.FC<AdminUnitsScreenProps> = ({
  users,
  paymentHistory,
  onNavigate,
  onDeleteUser,
  ...
  return (
    <div className="relative min-h-full pb-24" onClick={() => setMenuOpen(null)}>
      <div className="p-6 max-w-7xl mx-auto space-y-6 animate-page">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Gestiona los residentes y sus propiedades
            </p>
          </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-xl leading-5 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 focus:border-blue-500 sm:text-sm transition-shadow shadow-sm"
            value={searchTerm}
            ...
            return (
              <div key={resident.id} className="group relative">
                ...
                >
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 dark:border-gray-700 space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span
                        className={`font-medium ${resident.email ? 'text-gray-900 dark:text-white' : 'text-gray-400 italic'}`}
                      >
                    ...
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span
                        className={`font-medium ${lastPayment ? 'text-green-600 dark:text-green-400' : 'text-gray-400'}`}
                      >
                        {lastPayment
                          ? new Date(lastPayment.fechaPago).toLocaleDateString('es-CL')
                          : 'Sin pagos'}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span
                        className={`font-medium px-2 py-0.5 rounded text-xs ${resident.hasParking ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400'}`}
                      >
                ...
                {menuOpen === resident.id && (
                  <div
                    className="absolute top-14 right-4 mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-xl z-20 border border-gray-100 dark:border-gray-700 overflow-hidden animate-in fade-in zoom-in-95 duration-200"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <div className="py-1">
                      <button
                        onClick={() => {
                          onNavigate('admin-unit-edit', { id: resident.id });
                          setMenuOpen(null);
                        }}
                        className="w-full text-left flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors"
                      >
          ...
          {residents.length === 0 && (
            <div className="col-span-full py-12 text-center bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-dashed border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-500 dark:text-gray-400 mt-1 max-w-md mx-auto">
                Los usuarios creados en Supabase aparecerán aquí automáticamente si el trigger está
                configurado.
              </p>
            </div>
          )}
      ...
      <div className="fixed bottom-24 right-4 z-10 md:hidden">
        <button
          onClick={() => onNavigate('admin-unit-create')}
          className="bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900 focus:ring-4 focus:ring-blue-500/30 transition-transform hover:scale-105 active:scale-95"
              ...
              <label className="flex items-center p-4 border border-gray-200 dark:border-gray-700 rounded-xl cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <div className="flex-1">
                  ...
                  <span className="block text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                    Incluir cobro de estacionamiento en gastos comunes
                  </span>
                </div>
                <div className="relative inline-flex items-center cursor-pointer ml-4">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus-visible:ring-2 peer-focus-visible:ring-blue-500 peer-focus-visible:ring-offset-2 dark:peer-focus-visible:ring-offset-gray-900 peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                </div>
              </label>
            </div>
          </div>
...
export const AdminUnitDetailScreen: React.FC<AdminUnitDetailScreenProps> = ({
  user,
  paymentHistory,
  commonExpenseDebts,
  parkingDebts,
  ...
  const totalDebt =
    userCommonDebts.reduce((sum, d) => sum + d.monto, 0) +
    userParkingDebts.reduce((sum, d) => sum + d.monto, 0);
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <Card className="flex-1">
          <div className="flex items-start justify-between mb-6">
            ...
            <div
              className={`px-4 py-2 rounded-xl border ${totalDebt > 0 ? 'bg-red-50 border-red-100 text-red-700 dark:bg-red-900/20 dark:border-red-800 dark:text-red-400' : 'bg-green-50 border-green-100 text-green-700 dark:bg-green-900/20 dark:border-green-800 dark:text-green-400'}`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
              ...
              <p className="font-medium text-gray-900 dark:text-white">
                {user.hasParking ? 'Asignado' : 'No asignado'}
              </p>
            </div>
            <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
              <p className="text-gray-500 dark:text-gray-400 mb-1 flex items-center gap-2">
          ...
          {userCommonDebts.length === 0 && userParkingDebts.length === 0 ? (
            ...
            <div className="space-y-3">
              {userCommonDebts.map((debt) => (
                <Card
                  key={`common-${debt.id}`}
                  className="flex justify-between items-center border-l-4 border-l-red-500"
                >
                  <div>
                    ...
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          ...
                          {new Date(payment.fechaPago).toLocaleDateString('es-CL')}
                        </p>
                        {payment.metodoPago && (
                        ...
                        {payment.observacion && (
                          <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5 italic max-w-[200px] truncate">
                            {payment.observacion}
                          </p>
                        )}
                      </div>

...
export const AmenitiesScreen: React.FC<AmenitiesScreenProps> = ({
  amenities,
  onNavigate,
  onRefresh,
}) => {
    ...
    <div className="p-4 space-y-6 animate-page pb-24">
      <div className="flex justify-between items-center">
        ...
        <Button
          ...
          className="!py-2 !px-4 !text-sm shadow-md"
        >
        ...
        {amenities.length > 0 ? (
            ...
            <Card key={amenity.id} className="overflow-hidden !p-0 group">
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  ...
                  <p className="text-sm opacity-90 flex items-center gap-1">
                    <Icons name="users" className="w-3 h-3" /> Capacidad: {amenity.capacity}{' '}
                    personas
                  </p>
                </div>
              </div>
              <div className="p-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Button
                    onClick={() => onNavigate('reservations', { amenityId: amenity.id })}
                    variant="secondary"
          ...
          <div className="col-span-full text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1 mb-4">
              Contacte a la administración si cree que esto es un error.
            </p>
            {onRefresh && (
              <Button onClick={onRefresh} variant="secondary">
                <Icons name="arrow-path" className="w-4 h-4 mr-2" /> Reintentar Carga
              </Button>
            )}
          </div>
        )}

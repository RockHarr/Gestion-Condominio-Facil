-- Migration: Implement Morosity Check in request_reservation
-- Date: 2026-01-07
-- Description: Updates request_reservation to block reservations if the unit has unpaid debts in common_expense_debts or parking_debts.

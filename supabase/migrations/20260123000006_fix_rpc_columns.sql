-- Fix RPC: Remove 'fecha' and 'hora' columns from INSERT as they don't exist in the live table.
-- Using start_at and end_at instead.
...
BEGIN
    ...
    -- 3. Lookup Unit Name from Profile (Validation only)

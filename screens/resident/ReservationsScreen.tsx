...
import type { Amenity, Reservation, User } from '../../types';
import { Card } from '../../components/common/Card';
import Icons from '../../components/Icons';

export const ReservationsScreen: React.FC<{ amenities: Amenity[], reservations: Reservation[], user: User, onAddReservation: (res: Omit<Reservation, 'id'>) => boolean, onCancelReservation: (id: number) => void }> = ({ amenities, reservations, user, onAddReservation, onCancelReservation }) => {

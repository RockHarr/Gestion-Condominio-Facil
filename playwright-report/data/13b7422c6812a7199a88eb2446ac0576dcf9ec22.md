...
```ts
  ...
  7  | const RESIDENT_PASSWORD = process.env.TEST_RESIDENT_PASSWORD || 'dummy_resident_pwd';       // REPLACE WITH REAL RESIDENT PASSWORD
  8  | const ADMIN_EMAIL = 'rockwell.harrison@gmail.com';       // REPLACE WITH REAL ADMIN EMAIL
  9  | const ADMIN_PASSWORD = process.env.TEST_ADMIN_PASSWORD || 'dummy_admin_pwd';          // REPLACE WITH REAL ADMIN PASSWORD
  10 | // ==========================================
  11 |
